///Name: ShaderSubmiter
///Description: ShaderSubmiter accept shader source and compile/link them to glsl program
///Useage: AddShader() to add shader source to current program as well as compile it. LinkShader() to link all object file to a program. GetUnifromLocation() to get uniform locations in glsl for sending values
///Coder: Hao Pang
///Date: 2017.4.26
#pragma once
#include "GLCommon.h"
