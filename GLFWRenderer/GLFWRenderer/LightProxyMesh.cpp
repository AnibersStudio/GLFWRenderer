...
bool ProxyPyramid::InCircumscribeLight(glm::vec3 & eye, glm::vec3 & center, float range, float pixelsize)
{
...
glm::mat4 ProxyPyramid::GetMatrix(glm::vec3 eye, glm::vec3 & center, float range, float pixelsize)
{
...
bool ProxyIcosahedron::InCircumscribeLight(glm::vec3 & eye, glm::vec3 & center, float range, glm::vec3 dir, float coszero, float pixelsize)
{
	float distance = glm::length(eye - center);
...
glm::mat4 ProxyIcosahedron::GetMatrix(glm::vec3 eye, glm::vec3 & center, float range, glm::vec3 & dir, float coszero, float pixelsize)
{
	float additionalsize = glm::length(eye - center) * pixelsize * 0.5;
	float tanzeroangle = glm::sqrt(1 - coszero * coszero);
	float xoyscale = tanzeroangle * range * 2;
